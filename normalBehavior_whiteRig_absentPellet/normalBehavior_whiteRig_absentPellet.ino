...
const int fractionPelletsNotLoaded = 40; // fraction of wheel turns in which pellet is NOT presented
const int probabilityLoad = 80; // probability that pellet is present when cue turns on 
