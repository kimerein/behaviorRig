...
const long optoDelay = 1520; // delay from trial start until opto turns on in ms
...
const int probOfOpto = 70 ; // turn on opto in this percent of trials
const int probabilityCue = 80; // probability that cue turns on for any given trial, in %
